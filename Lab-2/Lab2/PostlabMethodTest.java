...
public class PostlabMethodTest
{
    ...
    private void verifySampleOutput(String outputString) 
    {
        ...
        checkFirstLineUnderscores(output.nextLine());
        ...
        //Skip the newline between underscore and new gross pay line
        try 
        {
        ...
        {
            fail("Output error - Did you put a new line after the last bar?");
        }
   ...
   /**
    ...
    private void checkFirstLineUnderscores(String firstLine)
    {
        if (noUnderscores(firstLine))
        {
            fail("Underscores missing from first line of output.\n"
                + "Make sure your prompts do not use println and do not " 
                + "contain newlines."
                + "\nMake sure you started and ended your paystub with " 
                + "lines of underscores."); 
        }
        
        if (!lineOfUnderscores(firstLine))
        { 
     ...
     * @return boolean value indicating success of the check
     */
    private boolean noUnderscores(String line)
    {
